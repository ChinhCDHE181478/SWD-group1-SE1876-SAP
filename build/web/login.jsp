<%-- 
    Document   : login
    Created on : Oct 28, 2025, 8:37:09 PM
    Author     : Chinh
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container py-5">
            ...
            <form action="login" method="post" class="row gy-3">
                <div class="col-12">
                ...
                <div class="col-12 d-flex gap-2">
                    ...
                    <a href="${pageContext.request.contextPath}/register" class="btn btn-outline-secondary">Register</a>
                </div>
            </form>
        </div>
