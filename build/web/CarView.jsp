                ...
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="${pageContext.request.contextPath}/feature.html" class="dropdown-item">Our Feature</a>
                            <a href="${pageContext.request.contextPath}/ViewCar.jsp" class="dropdown-item active">Our Cars</a>
                    ...
                    <!-- Điều kiện hiển thị theo trạng thái đăng nhập -->
                    <c:choose>
...
<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        ...
        <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/HomeServlet">Home</a></li>
...
<div class="container-fluid categories py-5">
    <div class="container py-5">
        ...
        <div class="categories-carousel owl-carousel wow fadeInUp" data-wow-delay="0.1s">
            <div class="categories-item p-4">
                <div class="categories-item-inner">
                    <div class="categories-img rounded-top">
                        <img src="${pageContext.request.contextPath}/img/car-1.png" class="img-fluid w-100 rounded-top" alt="Mercedes Benz R3">
                    </div>
            ...
            <!-- Các xe khác tương tự -->
            <div class="categories-item p-4">
                <div class="categories-item-inner">
                    <div class="categories-img rounded-top">
                        <img src="${pageContext.request.contextPath}/img/car-2.png" class="img-fluid w-100 rounded-top" alt="Toyota Corolla Cross">
                    </div>
                    <div class="categories-content rounded-bottom p-4">
...
<div class="container-fluid steps py-5">
    <div class="container py-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            ...
            <p class="mb-0 text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet nemo expedita asperiores commodi accusantium at cum harum, excepturi, quia tempora cupiditate! Adipisci facilis modi quisquam quia distinctio,</p>
        </div>
        <div class="row g-4">
...
<div class="container-fluid banner py-5 wow zoomInDown" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="banner-item rounded">
            <img src="${pageContext.request.contextPath}/img/banner-1.jpg" class="img-fluid rounded w-100" alt="">
            <div class="banner-content">
                ...
                <div class="banner-btn">
                    ...
                    <a href="${pageContext.request.contextPath}/contact.html" class="btn btn-primary rounded-pill py-3 px-4 px-md-5 ms-2">Contact Us</a>
                </div>
            </div>
        </div>
    </div>
